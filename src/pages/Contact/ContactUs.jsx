      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
            Have questions about an order, seller partnership, or product inquiries? Reach out and our team will get back to you promptly.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="p-6 rounded-3xl bg-white border border-slate-200/80 shadow-xs flex items-start gap-4 hover:border-[#2563eb]/40 transition-all">
              ...
              <div className="space-y-1">
                ...
                <a href="mailto:support@ilumaastudio.com" className="text-xs font-bold text-[#2563eb] hover:underline block pt-1">
            ...
            <div className="p-6 rounded-3xl bg-white border border-slate-200/80 shadow-xs flex items-start gap-4 hover:border-[#2563eb]/40 transition-all">
              ...
              <div className="space-y-1">
                <h3 className="font-bold text-slate-900 text-sm">Call Center</h3>
                <p className="text-xs text-slate-500">Mon-Sat, 9:00 AM to 7:00 PM IST</p>
                <a href="tel:+918001234567" className="text-xs font-bold text-emerald-600 hover:underline block pt-1">
                  +91 (800) 123-4567
                </a>
              </div>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-white border border-slate-200/80 shadow-xs flex items-start gap-4 hover:border-[#2563eb]/40 transition-all">
              ...
              <div className="space-y-1">
                <h3 className="font-bold text-slate-900 text-sm">Corporate Studio</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
                  ILumaa Studio Headquarters, Level 4, Tech Park Boulevard, Jaipur, Rajasthan 302001, India
                </p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-white border border-slate-200/80 shadow-xs flex items-start gap-4 hover:border-[#2563eb]/40 transition-all">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500">Monday – Saturday: 9:00 AM – 7:00 PM</p>
                <p className="text-xs text-slate-500">Sunday: Closed (Online orders open 24/7)</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-8 sm:p-10 border border-slate-200/80 shadow-xs space-y-6">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Fill in the details below and our customer success representatives will get in touch.
              </p>
            </div>
            ...
            {submitted ? (
              <div className="p-8 rounded-2xl bg-emerald-50 border border-emerald-200 text-center space-y-3">
                ...
                <h3 className="font-black text-emerald-900 text-base">Message Received!</h3>
                <p className="text-xs text-emerald-700 max-w-sm mx-auto">
                  Thank you for reaching out. We have logged your ticket and our representative will reply within 24 hours.
                </p>
                <button
                  type="button"
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="font-bold text-slate-700 block">Subject / Inquiry Type</label>
                    <select
                    ...
                    >
                      ...
                      <option value="Seller Inquiry">Become a Seller / Vendor</option>
                      <option value="Product Question">Product & Quality Details</option>
