  ...
  const fetchHeroSlides = useCallback(async () => {
    try {
      ...
      const formattedSlides = approvedSlides.map((slide, index) => ({
        ...
        buttonLink: slide.ctaLink || slide.buttonLink || "/shop",
        bgGradient:
          slide.bgGradient || "from-emerald-900 via-teal-900 to-slate-900",
      ...
      console.warn("Hero slides fetch failed:", error?.message || error);
          ...
          <div className="absolute inset-0 p-6 sm:p-10 md:p-12 flex flex-col md:flex-row justify-between gap-8">
            ...
            <div className="flex flex-col justify-center space-y-5 w-full md:w-1/2">
              ...
              <div className="space-y-2">
                <div className="h-4 w-full max-w-lg bg-slate-300 rounded" />
        ...
        <div className="w-full h-[280px] sm:h-[320px] md:h-[360px] rounded-3xl bg-slate-100 border border-slate-200 flex items-center justify-center">
          <div className="text-center px-6">
            ...
            <p className="mt-1 text-xs text-slate-400">
              New offers and promotions will appear here.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div
          className={`
            ...
            overflow-hidden
            bg-gradient-to-r ${activeSlide.bgGradient}
            text-white
        ...
        >
          ...
          <div className="space-y-4 max-w-xl text-left z-10">
            {activeSlide.badge && (
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-extrabold uppercase tracking-wider border border-white/10 bg-white/10 backdrop-blur-md">
            ...
            {activeSlide.buttonLink && (
              <div className="pt-2">
                <Link
                  ...
                  className="bg-[#2563eb] hover:bg-[#1d4ed8] text-white px-6 py-3 rounded-2xl text-xs sm:text-sm font-black transition-all duration-200 shadow-lg hover:shadow-blue-500/25 inline-flex items-center gap-2"
                >
          ...
          {activeSlide.image && (
            <div className="relative w-full md:w-1/2 h-44 sm:h-56 md:h-72 shrink-0 rounded-2xl overflow-hidden shadow-xl z-10 bg-slate-800">
              <img
                ...
                alt={activeSlide.title || "Campaign"}
                draggable="false"
