          ...
          <div className="bg-[#064E3B] text-white text-[11px] py-2 px-4">
            <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
              <div className="flex items-center gap-2 font-medium tracking-wide">
                ...
                <span>
                  {getSectionContent(effectiveSections, "announcement")?.text || (
                    <>
        ...
        {activePage === "home" && (
          <>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                  ...
                  <div className="lg:col-span-7 space-y-7 text-left">
                    <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-emerald-200/80 text-[#064E3B] text-xs font-semibold shadow-xs">
                      ...
                      <span>{heroContent.badge || "Cut Fresh This Morning from Local Botanical Growers"}</span>
                    </div>

                    <h1 className="text-4xl sm:text-6xl lg:text-[68px] font-serif font-black tracking-tight text-[#064E3B] leading-[1.08]">
                      {heroContent.title || "Poetic Bouquets Arranged with Wild Stems."}
                    </h1>

                    <p className="text-sm sm:text-base text-[#3E5C47] leading-relaxed max-w-xl font-normal">
                      {heroContent.description || heroContent.subtitle || "Every stem is hand-tied by master floral designers in hydration pouches with flower food packets and wax-sealed calligraphy gift cards. Guaranteed 7 days of fresh vibrancy."}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-4 pt-2">
                      ...
                      >
                        ...
                        <span>{heroContent.ctaText || "Order Fresh Bouquets"}</span>
                      </button>
                  ...
                  <div className="lg:col-span-5 relative">
                    <div className="relative mx-auto max-w-md lg:max-w-none">
                      ...
                      <div className="absolute -inset-4 bg-gradient-to-tr from-emerald-200/40 via-rose-100/30 to-amber-100/40 rounded-[40px] blur-2xl -z-10" />

                      {/* Main Featured Bouquet Frame */}
                      <div className="relative rounded-[36px] overflow-hidden border-8 border-white shadow-2xl bg-white aspect-[4/5] group">
                        <img
                          src={heroContent.image || "https://images.unsplash.com/photo-1561181286-d3fee7d55364?w=900&auto=format&fit=crop&q=80"}
                          alt="Signature Botanical Bouquet"
                          className="w-full h-full object-cover group-hover:scale-105 transition duration-700 ease-out"
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-80" />

                        <div className="absolute bottom-6 left-6 right-6 text-white text-left space-y-1">
                          <span className="text-[10px] uppercase font-bold tracking-[0.2em] text-emerald-300">Hand-Tied This Dawn</span>
                          <h3 className="text-xl sm:text-2xl font-serif font-bold text-white leading-snug">
                            The Provence Sunset Garden Rose
                          </h3>
                          <p className="text-xs text-emerald-100/90 font-light">Eucalyptus, blush garden roses, spray spray carnations, and dried bunny tails.</p>
                        </div>
                      </div>

                      {/* Floating Glassmorphic Badge 1 */}
                      <div className="absolute -bottom-6 -left-3 sm:-left-6 bg-white/95 backdrop-blur-md p-4 rounded-3xl shadow-xl border border-emerald-950/5 flex items-center gap-3">
                        <div className="w-10 h-10 rounded-2xl bg-emerald-100 text-emerald-800 flex items-center justify-center font-bold">
                          🌿
                        </div>
                        <div className="text-left">
                          <span className="text-xs font-serif font-bold text-[#064E3B] block">Cold-Van Shipped</span>
                          <span className="text-[10px] text-[#4A6451] block font-medium">In gel stem water bags</span>
                        </div>
                      </div>
            ...
            {isSectionEnabled(effectiveSections, "categories") && (() => {
              const catContent = getSectionContent(effectiveSections, "categories") || {};
              return (
            <section className="py-10 bg-white border-b border-emerald-950/5">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center space-y-1.5 mb-6">
                  <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#059669]">{catContent.badge || "Hand-Tied for Every Sentiment"}</span>
                  <h3 className="text-xl sm:text-2xl font-serif font-black text-[#064E3B]">{catContent.title || "Curated by Floral Occasion"}</h3>
                </div>
            ...
            {isSectionEnabled(effectiveSections, "featured_products") && (() => {
              const featContent = getSectionContent(effectiveSections, "featured_products") || {};
              return (
            <section className="py-16 sm:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 border-b border-emerald-950/10 pb-6">
                <div>
                  <span className="text-xs uppercase tracking-wider text-[#059669] font-bold">{featContent.badge || "In Bloom This Week"}</span>
                  <h2 className="text-3xl sm:text-4xl font-serif font-black text-[#064E3B]">{featContent.title || "Signature Arrangements"}</h2>
                  <p className="text-xs sm:text-sm text-[#4A6451] mt-1">{featContent.subtitle || featContent.description || "Directly sourced from organic growers and conditioned for maximum longevity."}</p>
                </div>
            ...
            {isSectionEnabled(effectiveSections, "promo_banner") && (() => {
              const promoContent = getSectionContent(effectiveSections, "promo_banner") || {};
              return (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  <div className="lg:col-span-8 space-y-4 text-left">
                    <span className="text-xs uppercase font-bold tracking-[0.2em] text-emerald-300">
                      {promoContent.badge || "The Custom Botanical Experience"}
                    </span>
                    <h2 className="text-3xl sm:text-4xl font-serif font-black leading-tight">
                      {promoContent.title || "Build Your Own Custom Bouquet in 4 Steps."}
                    </h2>
                    <p className="text-xs sm:text-sm text-emerald-100/80 leading-relaxed max-w-2xl font-light">
                      {promoContent.subtitle || promoContent.description || "Choose your focal stems, complementary foliage, presentation wrapping or fluted ceramic vase, and pen a handwritten wax-sealed calligraphy card with live visual preview."}
                    </p>
                  </div>
                  <div className="lg:col-span-4 flex justify-start lg:justify-end">
                    ...
                    >
                      <Sparkles size={16} className="text-[#059669]" />
                      <span>{promoContent.ctaText || "Launch Studio Builder"}</span>
                    </button>
                  </div>
                </div>
              </div>
            ...
            {isSectionEnabled(effectiveSections, "reviews") && (() => {
              const revContent = getSectionContent(effectiveSections, "reviews") || {};
              return (
            <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
              <div className="text-center space-y-2">
                <span className="text-xs uppercase tracking-wider text-[#059669] font-bold">{revContent.badge || "Botanical Testimonials"}</span>
                <h2 className="text-3xl font-serif font-black text-[#064E3B]">{revContent.title || "Cherished by 3,200+ Homes"}</h2>
                <p className="text-xs text-[#4A6451]">{revContent.subtitle || revContent.description || "Read unedited experiences from customers who ordered for anniversaries, dinner parties, and self-care."}</p>
              </div>
