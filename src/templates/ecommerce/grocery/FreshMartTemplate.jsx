          ...
          <>
            ...
            {isSectionEnabled(effectiveSections, "hero") && (
              <HeroSection
                brandName={brandName}
                banners={banners}
                heroContent={getSectionContent(effectiveSections, "hero")}
                onNavigateToAisles={() => {
                ...
                <div className="flex items-end justify-between border-b border-slate-100 pb-3">
                  <div>
                    <h2 className="text-2xl font-black text-slate-900">
                      {getSectionContent(effectiveSections, "categories")?.title || "Shop by Category"}
                    </h2>
                    <p className="text-xs text-slate-500 mt-0.5">
                      {getSectionContent(effectiveSections, "categories")?.subtitle || "Everything you need, all in one place."}
                    </p>
                  </div>
                <button
                  onClick={() => {
              ...
              <section className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 text-left">
                <div className="flex items-end justify-between border-b border-slate-100 pb-3">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      {getSectionContent(effectiveSections, "featured_products")?.subtitle || "Fresh picks, just for you."}
                    </p>
                  </div>
                  <button
                    onClick={() => {
